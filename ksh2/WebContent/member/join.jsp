			...
			<form action="joinPro.jsp" id="join" method="post" name="fr" onsubmit="return check()">
				<fieldset>
					...
					<input type="button" value="dup. check" class="dup"
						onclick="idcheck()"><br> <label>*비밀번호</label> <input
						type="text" name="pass"><br> <label>*비밀번호 확인</label>
					<input type="password" name="pass2"><br> <input
						type="hidden" name="passChecked" value="no"><br> <label>*이름</label>
					...
					<label>*이메일확인</label> <input type="email" name="email2"><br>
				</fieldset>

				<fieldset>
					<legend>부가정보</legend>
					<label>우편번호</label> <input type="text" name="postcode"
					...
					<br> <label>좌표정보</label> <input
						...
						placeholder="y좌표"> <input type="text" name="resultx"
            ...
            oncomplete: function(data) {
              ...
              //  document.getElementById("sample5_address").value = addr;
                ...
                //---------------------------------
					...
					<label>핸드폰 번호</label> <input type="text" name="mobile"><br>
				</fieldset>
				<div class="clear"></div>
				<div id="buttons">
