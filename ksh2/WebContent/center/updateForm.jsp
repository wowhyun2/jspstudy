...
<script type="text/javascript">
	function as() {
		...
		document.location.href = "updatePro.jsp?num=" + num + "&pass=" + pass;

	}
	function mySubmit(index) {
		if (index == 1) {

			document.myForm.action = 'updatePro.jsp?';
		}
		if (index == 2) {
			document.myForm.action = 'deletePro.jsp';
		}
		if (index == 3) {
			document.myForm.action = 'notice.jsp';
		}
	...
	<div id="wrap">
		...
		<article>
			...
			<form method="post" name="myForm" enctype="multipart/form-data">
				<table id="notice">
					<tr>
						<td class="twrite">글번호</td>
						<td class="ttitle"><input type="text" name="num"
							<%-- 						value="<%=bb.getNum()%>" ></td> --%>
								value="<%=bb.getNum()%>"></td>
					</tr>
					<tr>
						<td class="twrite">조회수</td>
						<td class="ttitle"><input type="text" name="readcount"
							value="<%=bb.getReadcount()%>"></td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td class="ttitle"><input type="text" name="subject"
							value="<%=bb.getSubject()%>"></td>
					</tr>
					<tr>
						<td class="twrite">첨부파일</td>
						<td class="ttitle"><input type="file" name="file"
							onchange="previewFile();addFile(this);">
							<br>
					...
					<tr>
						<td class="twrite">첨부파일</td>
						<td class="ttitle"><a href="../upload/<%=bb.getFile()%>">
						<img src="../upload/<%=bb.getFile()%>" width="500" height="300" id="preimage" onload="imageChange();addFile();"><br></a>
						<br><input type ="text" id="fileName" readonly style="border:0px;background-color:transparent" size ="50" value="<%=bb.getFile()%>">
						</td>
					</tr>
					<%
						}
					...
					<tr>
						...
						<td class="ttitle"><textarea name="content" rows="10"
								cols="20"><%=bb.getContent()%></textarea></td>
					</tr>
					<tr>
				...
				<div id="table_search">
					...
					%>
					<input type="button" value="수정확인" onclick="mySubmit(1)"> 
<!-- 					<input type="button" value="글삭제" onclick="mySubmit(2)"> -->
					<%
						}
						}
					%>
					<input type="button" value="글목록" onclick="mySubmit(3)">
