...
<!-- Container for the image gallery -->
  ...
  <!-- Full-width images with number text -->
    <div class="numbertext">현재글:<%=i +1%> / 전체글갯수:<%=boardList.size() %></div>
      <a href="content.jsp?num=<%=bb.getNum()%>&pageNum=<%=pageNum%>"><img src ="../upload/<%=bb.getFile()%>" style="width:100% ;height:350px"></a>
  </div>
<%  
}
}  
...
%>
    ...
    <div class="column">
      <img class="demo cursor" src="../upload/<%=bb.getFile()%>" style="width:100%;height:80px" onclick="currentSlide(<%=i+1 %>)" alt="<%=bb.getSubject()%>" >
    </div>
<%  
}
}  
